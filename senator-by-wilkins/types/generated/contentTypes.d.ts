...
export interface ApiReservacionReservacion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    cantidad_personas: Schema.Attribute.Integer;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    horario: Schema.Attribute.Enumeration<['Hora: 18-20', 'Hora: 20-22']>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::reservacion.reservacion'
    > &
      Schema.Attribute.Private;
...
export interface ApiRestauranteRestaurante extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    reservacions: Schema.Attribute.Relation<
      'oneToMany',
      'api::reservacion.reservacion'
    >;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::reservacion.reservacion': ApiReservacionReservacion;
